...
public class ShowData implements ListSelectionListener, ActionListener,
    ...
    private JButton municentoesmenos100;
...
//		middlePanel.setLayout(null);
        ...
        btn_ordmuninome.setBounds(1, 1, 161, 20);
        ...
        btn_quantmunirep.setBounds(251, 1, 182, 20);
        ...
        btn_munisulkax.setBounds(162, 1, 80, 20);
        middlePanel.add(btn_munisulkax);

        municentoesmenos100 = new JButton("liste municipios regiao Centro-oeste menos 100 mil");
        municentoesmenos100.addActionListener(this);
        municentoesmenos100.setBounds(162, 1, 80, 20);
        middlePanel.add(municentoesmenos100);
        ...
        btn_municenoest50a150.setBounds(251, 21, 182, 20);
